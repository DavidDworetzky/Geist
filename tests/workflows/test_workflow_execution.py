...
from app.services.workflow_execution import FunctionalProcessor, WorkflowExecutor, WorkflowStepType
...
class TestWorkflowExecutor:
    ...
    def test_execute_workflow_step_failure(self, mock_update_run, mock_update_step,
        ...
        with pytest.raises(Exception):  # noqa: B017 - engine raises bare Exception
