...
def test_tick(log, complete_text, mock_gpt4_agent, gpt4agent, client):
    ...
    assert response_payload ==  {'world_context': ["You are a meticulous thinker. \nGiven what you know about the world today, and the main task that you need to complete, consider if there are any additional facts that you should add to the list of ' + 'things you consider. \nDo not add anything that doesnt need to be added, consolidate anything that is worth consolidating with simpler statements.WORLD_CONTEXT:TASK_CONTEXT:Write a haiku:completion1", "You are a meticulous thinker. \nGiven what you know about the world today, and the main task that you need to complete, consider if there are any additional facts that you should add to the list of things you consider. \nDo not add anything that doesn't need to be added, consolidate anything that is worth consolidating with simpler statements.WORLD_CONTEXT:TASK_CONTEXT:Write a haiku:completion2"], 'task_context': [], 'execution_context': []} == {'world_context': ['You are a meticulous thinker. \nGiven what you know about the world today, and the main task that you need to complete, consider if there are any additional facts  that you should add to the list of things you consider. \n' + 'Do not add anything that doesnt need to be added, consolidate anything that is worth consolidating with simpler statements.WORLD_CONTEXT:TASK_CONTEXT:Write a haiku:completion2']}
