...
- `OPENROUTER_API_KEY` - OpenRouter API key for aggregated hosted models (e.g. Fireworks Ember-1, Union Alpha, GLM 5.3 Flash, Grok 4.6, Tencent Hy4 Preview, Muse Spark 1.2 Contributor, and Qwen 3.8 Max/Flash)
