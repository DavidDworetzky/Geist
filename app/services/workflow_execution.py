...
class TriggerProcessor(StepProcessor):
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Trigger step '{step.step_name}' failed: {str(e)}") from e
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                raise Exception(f"Unsupported functional step type: {step.step_type}") from None
            ...
            raise Exception(f"Functional step '{step.step_name}' failed: {str(e)}") from e
    ...
    def _process_reduce(self, data: Any, config: dict[str, Any]) -> Any:
        ...
        if "operation" in config:
            ...
            if op == "count":
                ...
                field = config["field"]
                values = [value for item in data if isinstance(item, dict)
...
class CustomProcessor(StepProcessor):
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Custom step '{step.step_name}' failed: {str(e)}") from e
...
class LLMProcessor(StepProcessor):
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"LLM step '{step.step_name}' failed: {str(e)}") from e
...
class AgentProcessor(StepProcessor):
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Agent step '{step.step_name}' failed: {str(e)}") from e
...
class AdapterProcessor(StepProcessor):
    ...
    def process(self, step: WorkflowStep, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Adapter step '{step.step_name}' failed: {str(e)}") from e
...
class WorkflowExecutor:
    ...
    def execute_workflow(self, workflow: Workflow, user_id: int, input_data: dict[str, Any] | None = None) -> WorkflowRun:
