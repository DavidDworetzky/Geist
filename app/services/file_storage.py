...
class FileStorageService:
    ...
    def validate_file(file_data: bytes, filename: str) -> dict[str, Any]:
        ...
        return {"valid": True, "mime_type": mime_type, "file_ext": file_ext}
    ...
    def store_file(file_data: bytes, original_filename: str, user_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to store file: {str(e)}"}

    @staticmethod
    def get_file_info(file_id: int) -> dict[str, Any] | None:
