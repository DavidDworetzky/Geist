...
async def get_processing_status(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get processing status: {str(e)}") from e
...
async def search_files(
    ...
    try:
        ...
        matching_files.sort(key=lambda x: float(x['match_score']), reverse=True)
