...
class SendGridAdapter(BaseAdapter):
    ...
    def __init__(self, sendgrid_api_key: str, from_email: str, from_name: str | None = None, **kwargs):
    ...
    def send_email(self, to_email: str, subject: str, content: str, to_name: str | None = None) -> str:
        """
    ...
    def send_template_email(self, to_email: str, subject: str, template: str,
                          tokens: dict[str, Any] | None = None, to_name: str | None = None,
